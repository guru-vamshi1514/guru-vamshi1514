...
<p align="center">
  ...
  <i>Crafting intelligent, data-driven web platforms, generative AI assistants, and high-performance full-stack applications.</i>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Focus-Full--Stack%20%26%20AI%2FML-blue?style=for-the-badge" alt="Focus">
  <img src="https://img.shields.io/badge/Stack-React%20%7C%20Angular%20%7C%20FastAPI%20%7C%20Node.js-purple?style=for-the-badge" alt="Stack">
  <img src="https://img.shields.io/badge/Databases-MongoDB%20%7C%20PostgreSQL-green?style=for-the-badge" alt="Databases">
</p>
...
#### 🎮 1. [Typeverse](https://github.com/guru-vamshi1514/Typeverse)
> **A full-stack gamified platform for typing skill mastery and telemetry analytics.**
- **5 Interactive Arcade Games**: Grand Prix racing, Zombie Typing Survival, Space Mission defense, Wizard Academy, and Dungeon Treasure Hunt.
- **Intelligent Adaptive Training**: Real-time per-character telemetry (hits, misses, accuracy) generating personalized practice drills targeting weak keys.
- **Data Insights**: Interactive Chart.js analytics dashboards with 7D/30D/90D time filters and automated progression text insights.
- **Gamification & Admin**: XP levels, daily streaks, achievements, global leaderboards, and administrative CMS.
- **Stack**: `Angular 20` • `Node.js` • `Express 5` • `MongoDB` • `Chart.js`

---

#### 🌍 2. [Smart AI Travel Planner](https://github.com/guru-vamshi1514/ai-travel-planner-application)
...
- **Features**: Google OAuth 2.0 & JWT authentication, live weather integration, budget calculation, and automated PDF itinerary export.
- **Stack**: `React.js` • `FastAPI` • `Python` • `Google Gemini AI` • `PostgreSQL`

---

#### 📊 3. [AI-Powered Data Visualization Assistant](https://github.com/guru-vamshi1514/gen-ai-project)
> **Automated data profiling, natural language insights, and interactive charting system.**
- **Natural Language Data QA**: Users upload raw CSV datasets and ask questions in plain English to receive automated statistical insights and recommended chart layouts.
- **Interactive Visualizations**: Supports bar, line, pie, scatter, histogram, and correlation heatmap charts powered by Recharts and Plotly.
- **Architecture**: **React + Vite** frontend with a **FastAPI (Python)** backend utilizing **Pandas, NumPy, and Scikit-learn** with LLM integration.
- **Stack**: `React` • `Vite` • `FastAPI` • `Python` • `Pandas` • `Recharts` • `OpenAI API`
